...
<body>
    ...
    <section class="bg">
        <div class="container">
            ...
            <div class="bg-text">
                <h2>Website Brows Store.</h2>
                <p>Sua felicidade, nossa alegria!</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="contato-wrapper">
                ...
                <div class="contato-single">
                    <div class="contato-text">
                        <i class="fa fa-asterisk" aria-hidden="true"></i>
                        <h2>Design Websites e Landing Page</h2>
                    </div>
                </div>
